...
>
> If you are using **any kind of AI assistance** to contribute to Foreseerr, it must be disclosed in the pull request.

### Disclosure Requirements

If you are using any kind of AI assistance while contributing to Foreseerr, **this must be disclosed in the pull request description**, along with the extent to which AI assistance was used (e.g., docs only vs. code generation).
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the repository to your own GitHub account and [clone](https://help.github.com/articles/cloning-a-repository/) it to your local device:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/foreseerr.git
   cd foreseerr/
   ```
...
2. Add the remote `upstream`:
   ...
   ```bash
   git remote add upstream https://github.com/selmant/foreseerr.git
   ```
