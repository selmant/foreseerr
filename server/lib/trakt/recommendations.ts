...
/** @deprecated Prefer getTraktRecommendationPage — kept for callers that need the full kept list. */
export async function getTraktRecommendationItems(
  ...
  return visibleFromKept(pool.kept, options.ignoreWatched, userId, trakt);
}
