...
> [!WARNING]
> Foreseer is currently in **alpha** (`v0.1.0-alpha.3`). Expect rough edges, breaking changes, and incomplete features. Back up your configuration before upgrading, and avoid using alpha builds as your only production instance.
...
docker run -d \
  ...
  ghcr.io/selmant/seerr:v0.1.0-alpha.3
```
...
services:
  foreseer:
    image: ghcr.io/selmant/seerr:v0.1.0-alpha.3
