...
---
:::info Foreseerr
Community packages below still use the upstream **Seerr** name. Prefer the Foreseerr Docker image (`ghcr.io/selmant/seerr`) or Helm chart (`foreseerr-chart`) from this fork when possible.
:::
