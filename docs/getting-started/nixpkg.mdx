...
---
:::info Foreseer
Nixpkgs packages the upstream **Seerr** project (`services.seerr`). For this Foreseer fork, prefer Docker/Compose or build from source until a dedicated package exists.
:::
