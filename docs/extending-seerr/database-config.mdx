...
description: Configure the database for Foreseer
sidebar_position: 2
---
# Configuring the Database

Foreseer supports SQLite and PostgreSQL. The database connection can be configured using the following environment variables:
...
1. Set up your PostgreSQL database and configure Foreseer to use it
2. Run Foreseer to create the tables in the PostgreSQL database
3. Stop Foreseer
...
**Recommended method**: Use the pgloader container even for standalone Foreseer installations. This avoids building from source and ensures compatibility.
