...
:::danger
Foreseerr is currently alpha software. Do not use your only production Seerr config or database for initial testing.
...
3. **A previous stable Foreseerr release**, once stable releases exist.
