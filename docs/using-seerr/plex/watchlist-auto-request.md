...
The Plex Watchlist Auto Request feature allows Foreseerr to automatically create requests for media items you add to your Plex Watchlist. Simply add content to your Plex Watchlist, and Foreseerr will automatically request it for you.
...
- You must have logged into Foreseerr at least once with your Plex account
- Your administrator must have granted you the necessary permissions
- Your Plex account must have access to the Plex server configured in Foreseerr
...
- Foreseerr will automatically create requests for new items
- You'll receive notifications when items are auto-requested

## How It Works

Once properly configured, Foreseerr will:
...
- Users must have logged into Foreseerr with their Plex account
