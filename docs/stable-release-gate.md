...
:::info Status
Maintainer-facing checklist for cutting a Foreseerr stable release. The alpha-removal procedure that lived here was completed for **`v0.1.0`**; the app is currently **`v0.8.0`** stable. Use this document when preparing the **next** stable tag, not as a gate to “leave alpha.”
:::
...
| Current app version | `package.json` → `0.8.0` |
